        ...
        <div className="py-6 sm:py-8 text-center animate-in fade-in zoom-in-95 duration-300">
          ...
          <div className="mt-6 p-5 bg-slate-50 border border-slate-200 rounded-xl text-left text-xs leading-relaxed text-slate-700 space-y-2">
            ...
            <p className="text-amber-700 font-bold bg-amber-50 p-2.5 rounded-lg border border-amber-200">
              ※このフォームからの送信は予約確定ではありません。ご希望内容を確認後、LINEまたはメールにて具体的な行程・必要な手配・費用をご案内いたします。
            </p>
            <p className="text-slate-600">
              ※表示されているガイド料金とは別に、交通費・入場料・お食事・アクティビティ等の実費が発生する場合があります。
            </p>
            <p className="text-slate-600">
              ※事前決済は不要です。日本語ガイド基本料金はベトナム到着後に全額お支払いいただけます（日本円・ベトナムドン対応）。
            </p>
          </div>
          ...
          <div className="p-3.5 bg-slate-50 rounded-xl flex items-start gap-2.5 text-[11px] text-slate-600 border border-slate-200">
            ...
            <div className="space-y-1">
              ...
              <p className="text-slate-600 leading-relaxed">
                日本語ガイド基本料金は、ベトナム到着後、ツアー開始前に全額お支払いいただきます。お支払いは、日本円（JPY）またはベトナムドン（VND）で可能です。ご予約時に事前のお支払いは必要ありません。
              </p>
              <p className="text-amber-800 font-semibold leading-relaxed text-[11px]">
                ※このフォームからの送信は予約確定ではありません。ご希望内容を確認後、LINEまたはメールにて具体的な行程・必要な手配・費用をご案内いたします。
              </p>
              <p className="text-slate-500 leading-relaxed text-[10px]">
                ※表示されているガイド料金とは別に、交通費・入場料・お食事・アクティビティ等の実費が発生する場合があります。キャンセルをご希望の場合は、ご予定日の1週間前までにご連絡ください。
              </p>
            </div>
          </div>
