      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-18 flex items-center justify-between">
        ...
        <div className="hidden sm:flex items-center gap-3">
          <Link
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-semibold text-[#06c755] bg-emerald-50 border border-emerald-200 rounded-full hover:bg-emerald-100 transition-colors"
          >
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-1.5 px-4 py-2 text-xs font-bold text-white bg-gradient-to-r from-amber-500 to-amber-600 rounded-full hover:from-amber-600 hover:to-amber-700 shadow-sm hover:shadow transition-all"
          >
