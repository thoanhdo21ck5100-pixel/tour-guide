  ...
  const pillars = [
    {
      ...
      solution:
        'ダナン出身で日本人のお客様対応を2年間経験した専属ガイドが、氷の品質や油、調理器具の清潔さを確認済みの「地元民が愛する名店」へご案内。注文時の「香草抜き」「辛味別添え」などの細かなリクエストもベトナム語で完全代行します。',
      guideQuestion:
    ...
    },
    {
      ...
      solution:
        '現地ローカルガイドが同行することで、観光客向けの高額店を避け、信頼できる老舗工房や地元適正価格で本物の高品質シルクやリネンを選定。仕上がった洋服のホテルお届けまで確実にサポートします。',
      guideQuestion:
      ...
      <div className="relative z-10 mt-6 pt-5 border-t border-amber-200/60 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="text-center sm:text-left">
          ...
          <p className="text-[11px] text-slate-500 mt-0.5">
            ダナン出身・JLPT N1の専属ガイドが、日本語で親身にお答えします（LINE事前相談無料）
          </p>
        </div>
