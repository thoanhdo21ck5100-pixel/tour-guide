    ...
    >
      ...
      <div className="relative h-48 sm:h-52 w-full overflow-hidden bg-slate-100 block">
        ...
        <div className="absolute top-3 left-3">
          <span className="px-2.5 py-1 bg-[#0B2545]/85 backdrop-blur-xs text-white text-[11px] font-semibold rounded-md shadow-xs">
            {post.category}
          </span>
        </div>
      </div>
      ...
      <div className="p-5 flex-1 flex flex-col justify-between">
        ...
        <div className="mt-5 pt-3.5 border-t border-slate-100 flex items-center justify-between">
          ...
          <div className="inline-flex items-center gap-1 text-xs font-bold text-amber-600 group-hover:text-amber-700 transition-colors">
            <span>読む</span>
