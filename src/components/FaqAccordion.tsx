  ...
  return (
    <div className="space-y-3">
      {FAQS_DATA.map((faq, idx) => (
        ...
        >
          <summary className="w-full p-4 sm:p-5 text-left flex items-center justify-between gap-4 hover:bg-slate-50/70 transition-colors cursor-pointer list-none [&::-webkit-details-marker]:hidden">
            ...
            <ChevronDown className="w-4 h-4 text-slate-400 shrink-0 transition-transform duration-200 group-open:rotate-180 group-open:text-amber-600" />
          </summary>
